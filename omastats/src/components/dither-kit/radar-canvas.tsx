...
import { BAYER, backingSize, bloomLayerStyle, easeInOutCubic, OFF_TIER, prefersReducedMotion } from "./dither-paint";
			...
			for (let y = 0; y < rows; y++) {
				...
				for (let x = 0; x < cols; x++) {
					...
					for (let pi = 0; pi < polys.length; pi++) {
						...
						const lit =
							variant === "solid" || density > BAYER[y & 3][x & 3] - 0.1 * intensity - bias + sparse;

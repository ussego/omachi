...
import { type AreaVariant, type SeriesKind, type StrokeVariant, useChartPart } from "./chart-context";
...
function CartesianSeries({
	...
	const onClick = isClickable ? () => ctx.selectDataKey(ctx.selectedDataKey === dataKey ? null : dataKey) : undefined;

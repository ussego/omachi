...
export function ReferenceLine({
	...
	return (
		<g>
			<line x1={0} x2={width} y1={py} y2={py} className={className} strokeDasharray={strokeDasharray} />
			{label ? (
				<text x={width - 2} y={py - 3} textAnchor="end" className="fill-muted-foreground font-mono text-[10px]">
					{label}
				</text>
			) : null}
		</g>

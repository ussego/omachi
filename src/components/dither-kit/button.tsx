...
export type DitherButtonProps = useRender.ComponentProps<"button"> & {
...
export function DitherButton({
	...
	// `type` is only valid on a <button> — omit it when a render prop replaces
	// the element (e.g. an anchor link). Same pattern as the coss Button.

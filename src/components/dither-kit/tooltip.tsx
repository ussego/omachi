...
export function Tooltip({
	...
	headingFormatter?: (value: string) => string;
	...
	const headingText = heading && headingFormatter ? headingFormatter(heading) : heading;
	...
	return (
		<AnimatePresence>
			{show && items.length > 0 && (
				...
				>
					{headingText && (
						<div className="mb-0.5 font-mono text-[10px] text-muted-foreground">{headingText}</div>
					)}

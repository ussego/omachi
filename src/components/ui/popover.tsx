		...
		<PopoverPrimitive.Portal {...portalProps}>
			...
			>
				<PopoverPrimitive.Popup
					className={cn(
						"relative flex h-(--popup-height,auto) w-(--popup-width,auto) origin-(--transform-origin) graph-frame bg-background text-foreground outline-none transition-[width,height,scale,opacity] duration-200 ease-out data-starting-style:scale-98 data-starting-style:opacity-0",

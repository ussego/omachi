/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 574bef7c710dd4bca9561cf2767dff94)
// Runtime types generated with workerd@1.20260828.1 2025-09-02 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	DB: D1Database;
	CATALOG_URL: "https://plugins.omarchy.org/catalog.json";
	EXPLORER_URL: "https://plugins.omarchy.org/explorer-data.json";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CATALOG_URL" | "EXPLORER_URL" | "STATS_URL">> {}
}
